...
const char* password = "GAURAV123"; // Your Wifi password, in case you have open network comment the whole statement.
 
int ledPin = D7; // GPIO13 or for NodeMCU you can directly write D7 
